...
import com.b04ka.structureful.worldgen.structures.laboratory.EndLaboratoryStructure;
...
public class ModStructureTypes {
    ...
    public static final Supplier<StructureType<EndLaboratoryStructure>> END_LABORATORY = STRUCTURE_TYPE.register("end_laboratory",()->()-> EndLaboratoryStructure.CODEC);
